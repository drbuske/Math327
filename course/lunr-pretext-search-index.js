...
},
{
  ...
  "body": " Practice Exam 2   Topics  Sections 2.1, 2.2, 2.3, 2.4, 2.5  Be sure to try each question before looking at the solutions.   Questions     Consider the differential equation     Explain why this differential equation is a second-order linear homogeneous differential equation.  Verify directly that and are solutions.  Using (b), explain how you know that is also a solution.      For part (a), recall the definitions.  For parts (b) and (c), compute and and substitute into the ODE to check whether the left-hand side equals zero.    The equation is second‑order linear homogeneous.  “Second order” means appears.  “Linear” means , , appear only to the first power and are not multiplied together.  “Homogeneous” means the right-hand side is zero.  Substitution shows that both and satisfy the ODE. By the superposition principle , any linear combination such as is also a solution.    (a) The equation   is second order because it involves . It is linear because , , and appear only to the first power and are not multiplied by one another or placed inside nonlinear functions. It is homogeneous because the right-hand side is zero.  (b) Verify that is a solution. Compute derivatives:   Substitute into the left-hand side of the ODE:   Thus is a solution.  Now verify . Compute derivatives:   Substitute:   Thus is also a solution.  (c) Because the equation is linear and homogeneous, any linear combination of solutions is again a solution. Therefore,   must satisfy the ODE. For completeness, substitute:   Hence is indeed a solution of the differential equation.       Consider the differential equation     Form the characteristic equation and find its roots.  Write down the general solution of the differential equation.  Find the particular solution satisfying the initial conditions and .      The associated characteristic equation is   Factor the quadratic to find two distinct real roots. When the characteristic roots are and , the general solution is   To apply initial conditions, compute and substitute .    The characteristic equation is , which factors to , giving roots and .  The general solution is   The initial conditions give and , so     (a) We form the characteristic equation by replacing with , with , and with :   This quadratic factors as giving the real distinct roots and .  (b) When the characteristic equation has real distinct roots, the general solution is   (c) Apply the initial condition :   Compute :   Apply :   We now solve the system:   Solving:   Therefore the particular solution is        Consider the differential equation     Find the general solution.  Determine the particular solution satisfying the initial conditions and .      Form the characteristic equation associated with :   Solve this quadratic to obtain complex roots of the form . When the roots are complex, the general solution has the form   Then apply the initial conditions to solve for and .    The general solution is The initial conditions give and , so the particular solution is     (a) To solve the differential equation   we form the characteristic equation   Solving this quadratic:   Since the roots are complex with real part and imaginary part , the general solution is   (b) Apply the initial conditions. First evaluate :   Since , we obtain .  Next compute . Differentiating,   Evaluate at :   Using and ,   so .  Therefore the solution satisfying the initial conditions is        A fourth-order linear homogeneous differential equation has the characteristic equation with roots   Write down the general solution of the differential equation.    If is a simple root of the characteristic equation, then is a solution.  If is a repeated root of multiplicity , then the corresponding solutions are   Combine all corresponding terms with arbitrary constants.    The general solution is     The given roots of the characteristic equation are:   (simple root),  (repeated twice),  (simple root).   For the simple roots and , the solutions are   For the repeated root of multiplicity 2, we take   Combining all four linearly independent solutions, the general solution is   where are arbitrary constants.       A fifth-order linear nonhomogeneous differential equation has homogeneous part associated with the factored characteristic equation    You are told that a particular solution to the full nonhomogeneous equation is   Write down the general solution of the nonhomogeneous differential equation.    For a simple real root , the homogeneous solution includes .  For a complex root of multiplicity , the real homogeneous solutions are   with pairs of such terms. Here the repeated complex roots have multiplicity , so you will have real homogeneous terms generated by them.  The general solution of the nonhomogeneous equation is     The general solution is     The given factored characteristic equation for the homogeneous part is   This yields:   a simple real root , and  a repeated complex conjugate pair of multiplicity .   The real solution corresponding to the simple real root is   For the repeated complex pair with real part and imaginary part , multiplicity produces four real linearly independent solutions:   Thus the homogeneous solution is   We are given a particular solution to the full nonhomogeneous equation to be   So the general solution of the nonhomogeneous differential equation is        A mass–spring system has mass kg and spring constant N\/m. The motion of the mass satisfies the differential equation   Suppose the mass is released from rest at a displacement of meters, so that . Find the equation of motion .    Divide the equation by to obtain the standard form   Here . The general solution of is   Apply the initial conditions and to find and .    The angular frequency is , and the equation of motion is     We begin with the equation of motion:   Divide through by :   Thus   The general solution of is   Apply the initial condition :   Now compute the derivative:   Apply :   Therefore the equation of motion is        A mass–spring–damper system is governed by the differential equation   Classify the motion of the system as underdamped , critically damped , or overdamped .    Consider the characteristic equation:   Compute the discriminant    If : overdamped.  If : critically damped.  If : underdamped.     The motion is critically damped .    Begin with the equation   Divide by to obtain the standard form:   The corresponding characteristic equation is   Compute the discriminant:   Since the discriminant is zero, the equation has a repeated real root. Therefore the motion is critically damped .       Consider the differential equation     Find the general solution of the associated homogeneous equation.  Use the method of undetermined coefficients to find a particular solution to the nonhomogeneous equation.  Write the general solution .      For part (a), solve the characteristic equation   For part (b), note that the forcing term is . Check whether is a solution of the homogeneous equation. If it is not, try a particular solution of the form   Substitute this guess into the left-hand side to solve for .     . A particular solution is . The general solution is     (a) Solve the homogeneous equation   Its characteristic equation is   This factors as   giving roots and . Therefore,   (b) To find a particular solution, try the form . Compute derivatives:   Substitute into the differential equation:   The left-hand side simplifies to   Since this yields , our guess fails because is already a solution of the homogeneous equation.  Therefore we multiply our guess by and instead try   Compute derivatives:   Substitute into the left-hand side:   Simplify:   Set this equal to the forcing term :   Thus a particular solution is   (c) The general solution is        Consider the nonhomogeneous differential equation     Find the general solution to the corresponding homogeneous equation.  Use variation of parameters to find a particular solution of the nonhomogeneous equation.  Write the general solution .      For the homogeneous equation , the characteristic equation is with roots and . Thus a fundamental set of solutions is and .  For variation of parameters, use the formulas   where is the Wronskian and .    A homogeneous solution is A particular solution is Thus the general solution is     (a) Solve the homogeneous equation   The characteristic equation is which factors as , giving and . Therefore,   (b) Apply variation of parameters. Let   Compute the Wronskian:   The forcing function is . Use the formula   Compute each integral:    Next,   Compute the integral:   Combine both contributions:   Since a particular solution is needed, we can absorb constant multiples of into the homogeneous term. Thus we may take the simpler equivalent form   (c) The general solution of the nonhomogeneous differential equation is       "
},
{
  "id": "sec21-linear-verification",
  "level": "2",
  "url": "ch-practice-exams-3.html#sec21-linear-verification",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "   Consider the differential equation     Explain why this differential equation is a second-order linear homogeneous differential equation.  Verify directly that and are solutions.  Using (b), explain how you know that is also a solution.      For part (a), recall the definitions.  For parts (b) and (c), compute and and substitute into the ODE to check whether the left-hand side equals zero.    The equation is second‑order linear homogeneous.  “Second order” means appears.  “Linear” means , , appear only to the first power and are not multiplied together.  “Homogeneous” means the right-hand side is zero.  Substitution shows that both and satisfy the ODE. By the superposition principle , any linear combination such as is also a solution.    (a) The equation   is second order because it involves . It is linear because , , and appear only to the first power and are not multiplied by one another or placed inside nonlinear functions. It is homogeneous because the right-hand side is zero.  (b) Verify that is a solution. Compute derivatives:   Substitute into the left-hand side of the ODE:   Thus is a solution.  Now verify . Compute derivatives:   Substitute:   Thus is also a solution.  (c) Because the equation is linear and homogeneous, any linear combination of solutions is again a solution. Therefore,   must satisfy the ODE. For completeness, substitute:   Hence is indeed a solution of the differential equation.   "
...
{
  "id": "ccsol-real-roots-example",
  "level": "2",
  "url": "ch-practice-exams-3.html#ccsol-real-roots-example",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "   Consider the differential equation     Form the characteristic equation and find its roots.  Write down the general solution of the differential equation.  Find the particular solution satisfying the initial conditions and .      The associated characteristic equation is   Factor the quadratic to find two distinct real roots. When the characteristic roots are and , the general solution is   To apply initial conditions, compute and substitute .    The characteristic equation is , which factors to , giving roots and .  The general solution is   The initial conditions give and , so     (a) We form the characteristic equation by replacing with , with , and with :   This quadratic factors as giving the real distinct roots and .  (b) When the characteristic equation has real distinct roots, the general solution is   (c) Apply the initial condition :   Compute :   Apply :   We now solve the system:   Solving:   Therefore the particular solution is    "
},
{
  "id": "second-order-linear-ode-exam",
  "level": "2",
  "url": "ch-practice-exams-3.html#second-order-linear-ode-exam",
  "type": "Exercise",
  "number": "3",
  "title": "",
...
{
  "id": "higher-order-given-roots",
  "level": "2",
  "url": "ch-practice-exams-3.html#higher-order-given-roots",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "   A fourth-order linear homogeneous differential equation has the characteristic equation with roots   Write down the general solution of the differential equation.    If is a simple root of the characteristic equation, then is a solution.  If is a repeated root of multiplicity , then the corresponding solutions are   Combine all corresponding terms with arbitrary constants.    The general solution is     The given roots of the characteristic equation are:   (simple root),  (repeated twice),  (simple root).   For the simple roots and , the solutions are   For the repeated root of multiplicity 2, we take   Combining all four linearly independent solutions, the general solution is   where are arbitrary constants.   "
},
{
  "id": "cc-hol-complex-repeated",
  "level": "2",
  "url": "ch-practice-exams-3.html#cc-hol-complex-repeated",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "   A fifth-order linear nonhomogeneous differential equation has homogeneous part associated with the factored characteristic equation    You are told that a particular solution to the full nonhomogeneous equation is   Write down the general solution of the nonhomogeneous differential equation.    For a simple real root , the homogeneous solution includes .  For a complex root of multiplicity , the real homogeneous solutions are   with pairs of such terms. Here the repeated complex roots have multiplicity , so you will have real homogeneous terms generated by them.  The general solution of the nonhomogeneous equation is     The general solution is     The given factored characteristic equation for the homogeneous part is   This yields:   a simple real root , and  a repeated complex conjugate pair of multiplicity .   The real solution corresponding to the simple real root is   For the repeated complex pair with real part and imaginary part , multiplicity produces four real linearly independent solutions:   Thus the homogeneous solution is   We are given a particular solution to the full nonhomogeneous equation to be   So the general solution of the nonhomogeneous differential equation is    "
},
{
  "id": "mechanical-vibrations-basic",
  "level": "2",
  "url": "ch-practice-exams-3.html#mechanical-vibrations-basic",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "   A mass–spring system has mass kg and spring constant N\/m. The motion of the mass satisfies the differential equation   Suppose the mass is released from rest at a displacement of meters, so that . Find the equation of motion .    Divide the equation by to obtain the standard form   Here . The general solution of is   Apply the initial conditions and to find and .    The angular frequency is , and the equation of motion is     We begin with the equation of motion:   Divide through by :   Thus   The general solution of is   Apply the initial condition :   Now compute the derivative:   Apply :   Therefore the equation of motion is    "
},
{
  "id": "mv-classification-easy",
  "level": "2",
  "url": "ch-practice-exams-3.html#mv-classification-easy",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "   A mass–spring–damper system is governed by the differential equation   Classify the motion of the system as underdamped , critically damped , or overdamped .    Consider the characteristic equation:   Compute the discriminant    If : overdamped.  If : critically damped.  If : underdamped.     The motion is critically damped .    Begin with the equation   Divide by to obtain the standard form:   The corresponding characteristic equation is   Compute the discriminant:   Since the discriminant is zero, the equation has a repeated real root. Therefore the motion is critically damped .   "
},
{
  "id": "undetermined-coefficients-easy",
  "level": "2",
  "url": "ch-practice-exams-3.html#undetermined-coefficients-easy",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "   Consider the differential equation     Find the general solution of the associated homogeneous equation.  Use the method of undetermined coefficients to find a particular solution to the nonhomogeneous equation.  Write the general solution .      For part (a), solve the characteristic equation   For part (b), note that the forcing term is . Check whether is a solution of the homogeneous equation. If it is not, try a particular solution of the form   Substitute this guess into the left-hand side to solve for .     . A particular solution is . The general solution is     (a) Solve the homogeneous equation   Its characteristic equation is   This factors as   giving roots and . Therefore,   (b) To find a particular solution, try the form . Compute derivatives:   Substitute into the differential equation:   The left-hand side simplifies to   Since this yields , our guess fails because is already a solution of the homogeneous equation.  Therefore we multiply our guess by and instead try   Compute derivatives:   Substitute into the left-hand side:   Simplify:   Set this equal to the forcing term :   Thus a particular solution is   (c) The general solution is    "
},
{
  "id": "nonhom-vop-easy",
  "level": "2",
  "url": "ch-practice-exams-3.html#nonhom-vop-easy",
  "type": "Exercise",
  "number": "9",
  "title": "",
